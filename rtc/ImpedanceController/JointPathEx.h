...
namespace hrp {
  ...
  public:
    ...
    bool calcInverseKinematics2Loop(const Vector3& dp, const Vector3& omega, const double LAMBDA, const double avoid_gain = 0.0, const double reference_gain = 0.0, const dvector* reference_q = NULL, const hrp::Vector3& localPos = hrp::Vector3::Zero());
    ...
    bool calcInverseKinematics2(const Vector3& end_p, const Matrix33& end_R, const Vector3& localPos, const Matrix33& localR, const double avoid_gain = 0.0, const double reference_gain = 0.0, const dvector* reference_q = NULL);
