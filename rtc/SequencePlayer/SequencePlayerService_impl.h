...
public:
  ...
  CORBA::Boolean setJointAnglesSequenceFullWithBSpline(CORBA::Short bspline_order, CORBA::Short bspline_id, CORBA::Double bstmin, CORBA::Double bstmax, const dSequence& bsp, const dSequenceSequence& jvss, const dSequenceSequence& vels, const dSequenceSequence& torques, const dSequenceSequence& poss, const dSequenceSequence& rpys, const dSequenceSequence& accs, const dSequenceSequence& zmps, const dSequenceSequence& wrenches, const dSequenceSequence& optionals, const dSequence &tms);
  // CORBA::Boolean setJointAnglesSequenceFullTest(const dSequenceSequence& jvss, const dSequenceSequence& vels, const dSequenceSequence& torques, const dSequenceSequence& poss, const dSequenceSequence& rpys, const dSequenceSequence& accs, const dSequenceSequence& zmps, const dSequenceSequence& wrenches, const dSequenceSequence& optionals, const dSequence &tms);
